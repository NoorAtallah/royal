  ...
  const capabilities = [
    {
      ...
      description: "Efficient retail management systems"
    },
    {
      title: "Inventory Control",
      description: "Advanced stock management solutions"
    },
    {
      title: "Customer Experience",
      description: "Enhanced shopping journey design"
    },
    {
        ...
        <div className={`transform transition-all duration-1000 ${
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-5xl font-bold text-white mb-4">
              Retail <span className="text-[#D7BE68]">Services</span>
            </h2>
            <p className="text-center max-w-3xl mx-auto text-lg mb-20 text-gray-400">
              At Royal Delta Group, we specialize in comprehensive retail solutions, helping businesses 
              thrive in today's competitive market through innovative strategies and efficient operations.
            </p>
          </div>
        </div>
        ...
        <div className="mt-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`transform transition-all duration-700 ${
              ...
              <h2 className="text-4xl font-bold text-white mb-6">Retail Excellence</h2>
              <div className="space-y-6 text-gray-400">
                <p className="text-lg">
                  With our extensive expertise and personalized approach, we provide guidance and 
                  support throughout your retail journey. From operations optimization to customer 
                  experience enhancement, we deliver comprehensive solutions for retail success.
                </p>
